...
public class RPropertiesIT {

  private static final Logger LOG = LoggerFactory.getLogger(RPropertiesIT.class);
  ...
  public REXP dataGenerator() {
    ...
    final double[] d4 =
        new double[] {100.1, 200.2, 300.3, 110.1, 220.2, REXPDouble.NA, 1234.4}; // dcol2
  ...
  public void testdataFrameColumnNamesFromConnection()
      throws StatisticsException, REngineException, REXPMismatchException {
    ...
    Assert.assertArrayEquals(
        new String[] {"iCol1", "iCol2", "dCol1", "dCol2"},
  ...
  @Test
  public void testCompute() throws REngineException, REXPMismatchException, StatisticsException {
    LOG.info("Null Check");
